...
plot (data$DateTime, data$Global_active_power, ylab ="Global Active Power", xlab ="", typ="l", cex=0.8)

plot (data$DateTime, data$Voltage, ylab ="Voltage", xlab ="datetime", typ="l", cex=0.8)
